<?php 
  ...
  $nameroom = $_REQUEST['name'];
  $idhotel  = $_REQUEST['hotel'];
  */
 ...
 ?>
  ...
  <input type="hidden" value="<?=$idroom?>" id='tipohabitacion'>
  <input type="hidden" value="<?=$idhotel?>" id='hotel'>
  <h3 align="center"><?=$nameroom?></h3>
  <div id="calendar"></div>
  <script src="<?php echo BASE_ADMIN?>plugins/fullcalendar/fullcalendar.min.js"></script>
  <script>
    $(function () {
      tipoha = $("#tipohabitacion").val();
      hotel  = $("#hotel").val();
      ...
      $('#calendar').fullCalendar({
        ...
        eventSources: [
          {
            url: 'res/php/user_actions/tarifas_diarias.php', // use the `url` property
  ...
  <script type="text/javascript" src="<?php echo BASE_ADMIN?>plugins/daterangepicker/moment.min.js"></script>
  <link rel="stylesheet" href="<?php echo BASE_ADMIN?>plugins/bootstrap-datapicker/css/bootstrap-datepicker.css">
  <script type="text/javascript" src="<?php echo BASE_ADMIN?>plugins/bootstrap-datapicker/js/bootstrap-datepicker.js"></script>
  <script>
    $(function () {
