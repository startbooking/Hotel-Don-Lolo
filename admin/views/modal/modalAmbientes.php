...
<div class="modal fade" id="myModalImprimeQR" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
  <form id="actualizaDatosAmbiente" class="form-horizontal" action="javascript:imprimeQRAmbiente()" method="POST" enctype="multipart/form-data">
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true"><span class="glyphicon glyphicon-off"></span></span></button>
          <h4 class="modal-title" id="exampleModalLabel">QR Carta Ambiente</h4>
        </div>
        <!-- <div id="datos_ajax_register"></div> -->
        <!-- <div id="mensajeMod"></div> -->
        <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <!-- <input type="hidden" id="imgLogoMod" name="imgLogoMod" value="">  -->
            <div class="col-lg-6 col-md-6" id="mostrarFotoMod">
              <img class="img-thumbnail" src="<?php echo $images ?>" alt="">
            </div>
            <!-- <label class="control-label col-lg-2" for="">Importar Logo</label>
            <div class="col-lg-2 col-md-2" >
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-warning" data-dismiss="modal"><i class="fa fa-reply"></i> Regresar</button>
          <button type="submit" class="btn btn-primary"><i class="fa fa-save"></i> Imprimir</button>
        </div>
      </div>
    </div>
  </form>
