<div class="modal fade" id="myModalAdicionarCentro" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
    ...
    <div class="modal-dialog modal-md" role="document">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title" id="exampleModalLabel">Adicionar Centro de Costo</h4>
        </div>
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <div class="col-lg-6 col-md-6">
              ...
              ?>
              <select class="form-control" name="deptoAdi" id="deptoAdi" required=""  >
          ...
          <div class="form-group">
            ...
            <div class="col-lg-3 col-md-3">
              <input type="text" class="form-control" id="gastoAdi" name="gastoAdi" required>
            </div>
          </div>
        </div>
