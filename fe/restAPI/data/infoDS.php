...
$eDocu['number'] = $eToken[0]['consecutivoDS'];; 
$eDocu['type_document_id'] = 11;
$eDocu['time'] = $horaDoc; 
...
$ePaym['duration_measure'] = "30";
$ePaym['payment_due_date'] = "2022-10-01";
...
// $resolution_number = ; 
// $prefix = ; 
//  $numeroDoc = $user->traeNumeroDocumento(2);
// $estadofactura = []; 
...
/* $datosProveedor = $user->getbuscaDatosProveedor($idProv);
...
/* if ($perfilFac == 1 && $docSoporte == 1) {
    ...
    $eDocSo['$date'] = $fechaDoc;
    $eDocSo['$time'] = $horaDoc;
   /*  $eDocSo['$notes'] = ;
    $eDocSo['$number'] = ; */
/*     $eDocSo['$prefix'] = $prefijo;
    $eDocSo['sendmail'] = false;
    $eDocSo['foot_note'] = null;
    $eDocSo['type_document_id'] = 11;
 */
