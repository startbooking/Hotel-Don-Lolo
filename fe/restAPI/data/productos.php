...
if ($_SERVER['REQUEST_METHOD'] == 'GET') {    
    ...
    extract($postBody);
    $result = $user->ingresaProducto(strtoupper($nombreAdi), strtoupper($codigoAdi), $ImptosAdi, $unidad, $precioAdi, $pucAdi, $centroAdi, strtoupper($descripcionAdi), $usuario, $codigoDian);
