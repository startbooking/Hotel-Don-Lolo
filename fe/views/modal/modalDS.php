      ...
      <div class="modal-dialog modal-md" role="document">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <h3 class="modal-title" id="exampleModalLabel">Anular Documento Soporte</h3>
          </div>
          <div id="mensaje"></div>
          <div class="modal-body">
            <input type="hidden" name="txtFacturaNro" id="txtFacturaNro" value="">
            <div class="form-group">
              <label for="noches" class="col-sm-2 control-label">Documento Soporte Nro</label>
              <div class="col-sm-2">
                <input type="number" class="form-control" name="documento" id="documento" readonly="">
              </div>
              <label for="llegada" class="col-sm-2 control-label">Fecha Documento</label>
              <div class="col-sm-4" style="padding-right: 20px">
                <input type="date" class="form-control" name="fechadoc" id="fechadoc" readonly="">
              </div>
            </div>                      
            <div class="form-group">
              <label class="control-label col-lg-2" for="verDocumentoModal">Documento Soporte</label>
              <div class="col-sm-10">
                <object id="verDocumentoModal" width="100%" height="250" data=""></object>
              </div>
            </div>
            <div class="form-group">
              <label class="control-label col-lg-2" for="motivoAnula">Motivo Anulacion</label>
              <div class="col-sm-10">
          ...
          <div class="modal-footer">
            <div class="row">
              <div class="col-md-6 col-md-offset-3">
                ...
                <div class="col-md-6">
                  <button class="btn btn-primary btn-block btnAnulaHis">
                  <I class="fa fa-save"></I> Anular</button>
                </div>
              </div>
            </div>
