...
<head>
  ...
  <title><?= TITLE_INV ?> | Sistema de Inventarios</title>
...
<body class="skin-green sidebar-mini">
  ...
  } elseif (isset($_GET['section']) && $_GET['section'] == 'recetasSalidas') {
    require 'views/recetasSalidas.php';
  ...
  <script src="<?= BASE_INV ?>res/js/ajax.js"></script>
  <script src="<?= BASE_INV ?>res/js/inventario.js"></script>
  ...
  <script>
    ...
    $('#usuarioActivo').html(apellidos + ' ' + nombres + ' <span class="caret"></span>')
