            ...
            <div class="panel panel-success panelFolio">
              <div class="panel-heading"> 
                <div class="panel-title">
                  ...
                  <input type="hidden" name="nrofolio1" id="nrofolio1" value="<?=$saldofolio1?>">
                  <input type="hidden" name="nrofolio2" id="nrofolio2" value="<?=$saldofolio2?>">
                  <input type="hidden" name="nrofolio3" id="nrofolio3" value="<?=$saldofolio3?>">
                  <input type="hidden" name="nrofolio4" id="nrofolio4" value="<?=$saldofolio4?>">
                ...
                <div class="container-fluid">
                  ...
                  <ul class="nav nav-tabs nav-justified">
                    <li class="active" id="folios1">
                      <a style="cursor:pointer;" data-toggle="tab" onclick="activaCongelado(<?=$reserva?>,1)">Folio 1
                      <?php 
                      if($saldofolio1<> 0){ ?>
                    ...
                    <li id="folios2">
                      <a style="cursor:pointer;" data-toggle="tab" onclick="activaCongelado(<?=$reserva?>,2)" >Folio 2 
                        <?php 
                        if($saldofolio2<> 0){ ?>
                          <span class="badge badge-danger fa fa-usd botonSaldo"> </span> 
                          <?php 
                    ...
                    <li id="folios3" disabled>
                      <a style="cursor:pointer;" data-toggle="tab" onclick="activaCongelado(<?=$reserva?>,3)" disabled>Folio 3
                        <?php 
                        if($saldofolio3<> 0){ ?>
                          <span class="badge badge-danger fa fa-usd botonSaldo"> </span> 
                          <?php 
                    ...
                    <li id="folios4" disabled>
                      <a style="cursor:pointer;" data-toggle="tab" onclick="activaCongelado(<?=$reserva?>,4)" disabled>Folio 4
                        <?php 
                        if($saldofolio4<> 0){ ?>
                          <span class="badge badge-danger fa fa-usd botonSaldo"> </span> 
                          <?php 
