<?php 
  ...
  $pdf->setXY(140,230);
  $pdf->MultiCell(60,5,utf8_decode('Certifico que valide el proceso interno establecido por Great Group SAS / I certify that it validates the internal process established by Great Group SAS.'),0,'C');
