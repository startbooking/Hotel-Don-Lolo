<?php 
  ...
  $pdf->MultiCell(95,6,'  
                        ...
                        Firma                                              Fecha',1,'L');
  $pdf->SetY(233);
  $pdf->MultiCell(95,4,'FACTURA IMPRESA POR COMPUTADOR. Resolucion Nro 18762012286441 del 2019-01-14 Habilitacion desde el No 341 al No 5063, Esta Factura de venta se asimila en todos sus efectos a una leta de cambio Art. 774 del Codigo de Comercio, Actvidad Economica Principal 5513 tarifa 4.00 x 1000',1,'C');
  $pdf->Ln(1);
