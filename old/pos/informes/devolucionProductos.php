...
<section class="content">
  <div class="panel panel-success">
    <div class="panel-heading"> 
      <div class="row">
        <div class="col-lg-9">
          ...
          <h3 class="w3ls_head tituloPagina"><i style="color:black;font-size:36px;" class="fa fa-industry"></i> Devolucion Productos</h3>
        </div>
      </div>
    </div>
    <div class="panel-body">
      ...
      <?php 
        include '../imprimir/imprimeDevolucionProductos.php';
      ?>
    </div>
  </div> 
</section>
