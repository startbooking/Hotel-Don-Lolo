<?php 
  ...
  $pdf->Cell(45,6,'Descuentos del Dia',1,0,'L');
  $pdf->Cell(25,6,number_format($ventasDia[0]['ingreso_descuentos'],2),1,1,'R');
  $pdf->Ln(2);
  $pdf->Cell(45,6,'Factuas Anuladas',1,0,'L');
  $pdf->Cell(25,6,number_format($ventasDia[0]['mesas_anuladas'],0),1,1,'R');
  ...
  $pdf->Cell(45,6,'Descuentos',1,0,'L');
  $pdf->Cell(25,6,number_format($ventasDia[0]['ingreso_descuentos'],2),1,0,'R');
  $pdf->Cell(25,6,number_format($ventasMes[0]['mesDes'],2),1,0,'R');
  $pdf->Cell(25,6,number_format($ventasAnio[0]['anioDes'],2),1,1,'R');
  $pdf->Ln(2);
