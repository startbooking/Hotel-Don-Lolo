<?php 
  ...
  foreach ($codigos as $codigo) { 
    $pdf->Cell(50,6,utf8_decode(substr($codigo['descripcion'],0,30)),0,0,'L');
  ...
  $pdf->Cell(50,6,utf8_decode(substr('TOTAL PAGOS',0,30)),0,0,'L');
