<?php 
  ...
  include_once '../../../imprimir/imprimeBalanceDiarioAuditoria.php';
  ...
  include_once '../../../imprimir/imprimeGerenciaDiariaAuditoria.php';
  
  $ventas   = $pos->getTotalProductosVendidos($idamb);
  $cantidad = $pos->getCantidadProductosVendidos($idamb);

  include_once '../../../imprimir/imprimeVentasPorProductoAuditoria.php';

  $ventas   = $pos->getTotalGruposVendidos($idamb);
  $cantidad = $pos->getCantidadProductosVendidos($idamb);

  include_once '../../../imprimir/imprimeVentasPorGrupoAuditoria.php';
  ...
  include_once '../../../imprimir/imprimeDiarioAcumulado.php';  
  include_once '../../../imprimir/imprimeDiarioGruposAcumulado.php';
  include_once '../../../imprimir/imprimeDiarioFormasdePago.php';
