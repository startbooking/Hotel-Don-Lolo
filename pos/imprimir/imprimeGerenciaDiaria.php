<?php 
  ...
  require '../../../../res/shared/HorizontalAuditoriaFpdf.php';
  ...
  $pdf->Cell(45,6,'Habitaciones Diponibles',1,0,'L');
  ...
  $file = '../imprimir/auditorias/Informe_Diario_Gerencia_'.FECHA_POS.'.pdf';
  $pdf->Output($file,'F');
?>
