        ...
        <div class="panel-body">
          ...
          <div class="container-fluid galeria" id='procesosCierreCajero' >
            <div class="col-md-10 col-sm-12" style="padding:0">
              <h4 style="text-align:center;padding:10px" class="bg-red" style="">
              <img style="width: 44px;margin-top:0" class="img-thumbnail" src="<?=BASE_WEB?>img/alert2.png" alt="">
              <span style="font-size:20px;font-weight: 700;font-family: 'ubuntu';"> Este Proceso No Permitira Ingresar Nuevos Movimientos Al Sistema</span></h4>
            </div>
          </div>
