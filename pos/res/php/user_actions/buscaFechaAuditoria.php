...
<div class="table-responsive">
  ...
  <table id="example1" class="table table-bordered">
    ...
    <tbody>
      ...
      <tr style='font-size:12px'>
        <td style="padding:3px 5px">Ventas a Credito del Dia</td>
        <td style="padding:3px 5px;text-align:center">
          <button class="btn btn-info btn-xs" type="button"><i class="fa fa-file-pdf-o" aria-hidden="true" onclick="verAuditoria('VentasCreditoDia_<?=$prefijo.'_'.$fecha?>.pdf')"></i></button>
        </td>
      </tr>
      <tr style='font-size:12px'>
