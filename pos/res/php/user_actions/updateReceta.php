...
<div class="modal-body">
  <div class="form-group">
    <div class="col-md-9">
      <div class="form-group">
        <input type="hidden" name="idReceta" id="idReceta" value="<?php echo $updateRec[0]['id_receta']; ?>">
        <label for="receta" class="control-label col-lg-2 col-md-2" style="padding:5px">Receta</label>
        <div class="col-lg-6 col-md-6">
          <input type="text" class="form-control" id="receta" name="receta" required value="<?php echo $updateRec[0]['nombre_receta']; ?>">
        </div>
        <label for="porcion" class="control-label col-lg-2 col-md-2">Porciones</label>
        <div class="col-lg-2 col-md-2">
          <input type="number" min='1' class="form-control" id="porcion" name="porcion" required value="<?php echo $updateRec[0]['cantidad']; ?>">
        </div>
      </div>
      <div class="form-group">
      ...
      <div class="form-group">
        ...
        <div class="col-lg-2 col-md-2" style="padding:5px 0 5px 15px">
          <input type="number" min='0' class="form-control" id="vlrVenta" name="vlrVenta" required maxlength="12" value="<?php echo $updateRec[0]['valor_venta']; ?>"> 
        </div>
        <label for="vlrVenta" class="control-label col-lg-2  col-md-2">% Margen Error</label>
        <div class="col-lg-2 col-md-2">
          <input type="number" min='0' class="form-control" id="margen" name="margen" required maxlength="12" value="<?php echo $updateRec[0]['margen_error']; ?>"> 
        </div>
        <label for="costo0" class="control-label col-lg-2  col-md-2">Tiempo Coccion</label>
        <div class="col-lg-2 col-md-2">
          <input type="number" min='1' class="form-control" id="tiempo" name="tiempo" required maxlength="12" value="<?php echo $updateRec[0]['duracion_prep']; ?>"> 
        </div>
      </div>
    </div> 
    <div class="col-md-3">
