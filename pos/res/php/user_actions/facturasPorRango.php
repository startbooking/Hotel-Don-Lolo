          ...
          <tr style='font-size:12px'>
            ...
            <td style="padding:3px 5px;text-align: center">
              <div class="btn-group" role="group" aria-label="Basic example">
                <button class="btn btn-info btn-xs" type="button" data-toggle="modal" data-apellidos="<?= $factura['apellido1'] . ' ' . $factura['apellido2'] ?>" data-nombres="<?= $factura['nombre1'] . ' ' . $factura['nombre2'] ?>" data-fechafac="<?= $factura['fecha'] ?>" data-factura="Factura_<?= $prefijo ?>-<?= $factura['factura'] ?>" data-numero="<?= $factura['factura'] ?>" data-pms="<?= $factura['pms'] ?>" onclick="verfacturaHis('<?= $factura['factura'] ?>','Factura_<?= $prefijo ?>-<?= $factura['factura'] ?>.pdf')" title="Ver Factura">
