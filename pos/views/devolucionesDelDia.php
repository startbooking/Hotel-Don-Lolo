<?php
  ...
  $comandas = $pos->getDevolucionesDia($idamb);
  ...
  <div class="content-fluid" style="margin-bottom: 50px">
    <div class="panel panel-success">
      <div class="panel-heading">
        ...
        <h3 class="w3ls_head tituloPagina"> <i class="fa fa-tachometer" style="font-size:36px;color:black" ></i> Devoluciones del Dia</h3>
      </div> 
            ...
            <?php 
              ...
              if($regis==0){ ?>
                <div class="container-fluid">
                  <h4 class="bg-red-gradient" style="padding:10px;text-align: center;font-weight: 600;width: 30%">Devoluciones En el Dia <span style="font-size:16px;font-weight: 600;font-family: 'ubuntu'"></span></h4>         
                </div>
                <?php 
              }else{ ?> 
                      ...
                      <tbody>
                        ...
                        foreach ($comandas as $factura) { ?>
                          <tr style='font-size:12px'>
                            <td style="padding:3px 5px"><?php echo $factura['comanda']; ?></td>
                            <td style="padding:3px 5px"><?php echo $factura['fecha_comanda_anulada']; ?></td>
