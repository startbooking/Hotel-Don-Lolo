...
<section class="content">
  <div class="col-md-6" style="left:25%;margin-top:10%;">
    <div class="panel panel-success">
      ...
      <form id="formCierreDiario" style="padding:0px;" class="form-horizontal" action="javascript:cierreDiario()" method="POST" enctype="multipart/form-data">
        <div class="panel-body">
          <div class="form -group">
            <div class="form-group">
              <label style="margin-top:8px" for="fechaAuditoria" class="col-sm-5 control-label">Fecha Auditoria </label>
              <div class="col-sm-6">
                <h3 id="fechaAuditoria" style="font-weight: 700;margin-top: 0;font-size:30px;color:brown"><?php echo $fecha; ?></h3>
              </div>
            </div>
          </div>
        ...
        <div class="panel-footer" style="text-align: center">
          <a style="width: 20%" type="button" class="btn btn-warning" onclick="getSeleccionaAmbiente(<?php echo $idamb; ?>)"><i class="fa fa-home"></i> Regresar</a >
