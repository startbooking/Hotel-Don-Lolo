    ...
    <div class="modal-dialog modal-md" role="document">
      <div class="modal-content modal-md">
        <div class="modal-header">
          ...
          <input type="hidden" name='totalCuentPag' id='totalCuentPag' value='0'>
        </div>
    ...
    <div class="modal-dialog modal-md" role="document">
      <div class="modal-content modal-md">
        <div class="modal-header">
          ...
          <input type="hidden" name='totalCuentaDir' id='totalCuentaDir' value=''>
  ...
  <form class="form-horizontal" method="POST" accept-charset="utf-8" id="guardaClienteComanda" action="javascript:guardaClienteComanda()">
    <div class="modal-dialog modal-md" role="document">
      <div class="modal-content modal-md">
        ...
        <div class="modal-body">
          <div class="form-group">
            <label class="col-lg-3 col-md-3 control-label" style="padding-top:0px;">Cliente</label>
            <div class="col-lg-8 col-md-8">
