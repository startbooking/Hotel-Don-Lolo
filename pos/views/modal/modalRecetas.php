    ...
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        <div class="modal-header modal-info">
          ...
          <h3 style="margin:0;font-weight: 700;" class="modal-title w3ls_head"><span class="fa fa-cube"></span> Adicionar Receta</h3>
        </div>
        ...
        <div class="modal-body">
          <div class="form-group">
            ...
            <label for="porcion" class="control-label col-lg-2 col-md-2 pd0">Porciones</label>
          ...
          <div class="form-group">
            ...
            <label for="tiempo" class="control-label col-lg-2 col-md-2 pd0">Tiempo Coccion</label>
            <div class="col-lg-2 col-md-2">
          ...
          <div class="form-group">
            ...
            <div class="col-lg-10 col-md-10">
              <textarea id="preparacion" name="preparacion" id="" cols="30" rows="8"></textarea>
            </div>
          </div>
          <div class="form-group">
            <label for="montaje" class="control-label col-lg-2  col-md-2">Montaje</label>
            <div class="col-lg-10 col-md-10">
              <textarea id="montaje" name="montaje" id="" cols="30" rows="8"></textarea>
            </div>
          </div>
        </div>
                ...
                <div class="row producto" style="display: flex;">
                  ...
                  <div class="col-lg-6">
                    <button
                      ...
                      id="btnSubReceta"
                      title="Sub Recetas - Receta Estandar"><i class="fa fa-plus-circle" aria-hidden="true"></i> Adicionar SubReceta
                    </button>
                    <button
                      type="button"
                      class="btn btn-success pull-right"
                      onclick='adicionaMateriaPrima()'
                      title="Materia Prima Receta Estandar"><i class="fa fa-plus-circle" aria-hidden="true"></i> Adicionar Producto
                    </button>
                  </div>
                </div>
              </div>
