        ...
        <div class="row">
          <div class="col-md-6">
            ...
            <h3 class="w3ls_head tituloPagina">
              <i style="color:black;font-size:36px;" class="fa fa-industry"></i> Historico Grupos de Productos
            </h3>
          </div>
          <div class="col-md-6">
            <button class="btn btn-success btnTitle" type="buttom" onclick='historicoGrupos()'><i class="fa fa-print" aria-hidden="true"></i> Imprimir</button>
          </div>
        </div>
      </div>
