            ...
            <div class="col-lg-6 form-group">
              ...
              <div class="form-group has-success has-feedback col-sm-6">
                <div class="input-group" style="padding-left:15px;">
                  <input style="line-height:16px;" type="date" class="form-control" id="buscarFecha" aria-describedby="inputGroupSuccess4Status" value="<?= $fecha ?>" max="<?= $fecha ?>">
                  <span class="input-group-addon" style="padding:1px;border:none">
                    <a onclick="buscaFacturasFecha()" href="#">
