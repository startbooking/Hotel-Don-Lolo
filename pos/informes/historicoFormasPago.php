...
<section class="content">
  <div class="panel panel-success">
    <div class="panel-heading">
      <div class="row">
        <div class="col-lg-9">
          ...
          <input type="hidden" name="ubicacion" id="ubicacion" value="historicoFormasPago">
          <h3 class="w3ls_head tituloPagina">
            <i style="color:black;font-size:36px;" class="fa fa-industry"></i> Ventas Por Forma de Pago
          </h3>
        </div>
      </div>
    </div>
    <div class="panel-body">
      ...
      <?php
      include_once '../imprimir/imprimeVentasPorProducto.php';
      ?>
    </div>
  </div>
</section>