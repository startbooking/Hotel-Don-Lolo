...
/* define('PAIS_EMPRESA', $hotel->getLandName($empresa['pais']));
define('CIUDAD_EMPRESA', $hotel->getCityName($empresa['ciudad']));
 */
define('PAIS_EMPRESA', $empresa['descripcion']);
define('CIUDAD_EMPRESA', $empresa['municipio']);
define('CODE_CITY_COMPANY', $empresa['ciudad']);
define('WEB_EMPRESA', $empresa['web']);
define('CORREO_EMPRESA', $empresa['correo']);
define('RNT', $empresa['rnt']);
define('LOGO', $empresa['logo']);
define('xPOS', $empresa['xlogo']);
define('yPOS', $empresa['ylogo']);
define('tPOS', $empresa['tlogo']);
define('CIIU', $empresa['codigo_ciiu']);
define('TIPOEMPRESA', $hotel->getTypeCia($empresa['tipo_empresa']));
