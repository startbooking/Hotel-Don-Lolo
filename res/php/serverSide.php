...
class TableData { 
	...
	public function get($table, $index_column, $columns) {
		// Paging
		// echo $table, $index_column, print_r($columns);
		...
		$iFilteredTotal = current($hotel->lanzaQuery('SELECT FOUND_ROWS()'));
		...
		$iTotal = $hotel->lanzaQuery($sQuery);
