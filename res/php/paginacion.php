...
class PDO_Pagination{
	...
	public function __construct($connection) {
		$this->btn_first_page    = 'Inicial';
		$this->btn_last_page     = 'Final';
		$this->btn_next_page     = 'Proximo';
		$this->btn_back_page     = 'Anterior';
		$this->btn_page          = 'Pagina';
		$this->btn_active        = 'active';
		return $this->connection = $connection;
	}

public function conectaDB($host, $dbname, $root, $password){
	PDO("mysql:host=$host;dbname=$dbname;", $root, $password);
}
