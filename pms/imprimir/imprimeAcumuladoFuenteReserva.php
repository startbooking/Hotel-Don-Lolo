<?php 
  ...
  $pdf->Cell(30,5,utf8_decode('CANT AÑO'),0,0,'C');
  $pdf->Cell(30,5,utf8_decode('VALOR AÑO'),0,1,'C');
  ...
  foreach ($codigos as $codigo) { 
    $pdf->Cell(70,6,utf8_decode(substr($codigo['descripcion_grupo'],0,30)),0,0,'L');
    ...
    if(count($diafuen)==0){$cant = 0 ;}else{$cant = $diafuen[0]['nro']; }
    if(count($diafuen)==0){$valo = 0 ;}else{$valo = $diafuen[0]['val']; }
    if(count($mesfuen)==0){$canmes = 0 ;}else{$canmes = $mesfuen[0]['nro']; }
    if(count($mesfuen)==0){$valmes = 0 ;}else{$valmes = $mesfuen[0]['val']; }
    if(count($anifuen)==0){$canani = 0 ;}else{$canani = $anifuen[0]['nro']; }
    if(count($anifuen)==0){$valani = 0 ;}else{$valani = $anifuen[0]['val']; }
    /*
  ...
  $pdf->Cell(70,6,utf8_decode(substr('TOTAL RESERVAS',0,30)),0,0,'L');
