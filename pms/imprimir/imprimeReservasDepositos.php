<?php 
  ...
  $pdf->Cell(30,6,'Deposito',0,0,'L');
  $pdf->Cell(50,6,'Forma de Pago ',0,0,'C');
  $pdf->Cell(20,6,'Cons. ',0,0,'C');
  ...
  if($regis==0){
      $pdf->Cell(260,6,'SIN DEPOSITOS A RESERVAS ',0,0,'C');    
  }else{
    $sal = 0;
    foreach ($depositos as $deposito) {
      $pdf->Cell(10,5,$deposito['num_reserva'],0,0,'C');
      $pdf->Cell(10,6,$deposito['num_habitacion'],0,0,'L');
      ...
      $pdf->Cell(50,5,$deposito['descripcion_cargo'],0,0,'L');
      $pdf->Cell(20,5,$deposito['concecutivo_deposito'],0,0,'R');
