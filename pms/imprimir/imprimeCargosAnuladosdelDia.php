<?php 
  ...
  $pdf->Cell(40,6,'Motivo Anulacion',0,0,'C');
  ...
  foreach ($cargos as $cargo) {
    ...
    $pdf->Cell(50,5,substr(utf8_decode($cargo['apellido1'].' '.$cargo['apellido2'].' '.$cargo['nombre1'].' '.$cargo['nombre2']),0,22),0,0,'L');
    $pdf->Cell(40,5,substr(utf8_decode($cargo['descripcion_cargo']),0,19),0,0,'L');
    ...
    $pdf->Cell(40,5,substr(utf8_decode($cargo['motivo_anulacion']),0,19),0,0,'L'); 
    $pdf->Cell(20,5,$cargo['usuario'],0,0,'L'); 
  ...
  $pdf->Cell(110,5,'Total Cargos Anulados del Dia ',0,0,'L');
