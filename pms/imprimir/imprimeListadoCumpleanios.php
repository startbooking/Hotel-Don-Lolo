<?php 
  ...
  $pdf->Cell(30,5,utf8_decode('Cumpleaños'),0,1,'C');
  $pdf->SetFont('Arial','',9);
  foreach ($huespedes as $huesped) {
    $pdf->Cell(70,4,substr(utf8_decode($huesped['nombre_completo']),0,35),0,0,'L');
    $pdf->Cell(70,4,substr(utf8_decode($huesped['direccion']),0,32),0,0,'L');
    $pdf->Cell(30,4,substr($huesped['telefono'],0,12),0,0,'L');
