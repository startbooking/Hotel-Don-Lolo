<?php 
  ...
  foreach ($cargos as $cargo) {
    ...
    $pdf->Cell(50,6,substr(utf8_decode($cargo['apellido1'].' '.$cargo['apellido2'].' '.$cargo['nombre1'].' '.$cargo['nombre2']),0,22),0,0,'L');
    ...
    $pdf->Cell(60,6,substr(utf8_decode($cargo['motivo_anulacion']),0,24),0,0,'L'); 
    $pdf->Cell(20,6,$cargo['usuario'],0,0,'L'); 
    $pdf->Cell(10,6,$cargo['factura_numero'],0,0,'R'); 
