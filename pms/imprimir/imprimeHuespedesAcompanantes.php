<?php 
  ...
  if($regis==0){
    ...
    foreach ($reservas as $reserva) {
      ...
      $pdf->Cell(70,6,utf8_decode($reserva['nombre_completo']),0,0,'L');
      ...
      $pdf->Cell(20,6,$reserva['estado'],0,1,'C');
      ...
      if(count($acompanantes)<>0){
        foreach ($acompanantes as $acompanante) {
          $pdf->Cell(10,6,'',0,0,'L');
          $pdf->Cell(70,6,utf8_decode($acompanante['apellido1'].' '.$acompanante['apellido2'].' '.$acompanante['nombre1'].' '.$acompanante['nombre2']),0,1,'L');
        }
