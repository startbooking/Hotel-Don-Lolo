<?php 
  ...
  $pdf->Cell(30,6,substr(($hotel->getCityExp($datosReserva[0]['origen_reserva'])),0,20),1,0,'L');
  $pdf->Cell(20,6,'Destino',1,0,'l');
  $pdf->Cell(30,6,substr(($hotel->getCityExp($datosReserva[0]['destino_reserva'])),0,20),1,0,'L');
