<?php 
  ...
  $pdf->Cell(30,5,($hotel->getLandGUest($datosHuesped[0]['pais'])),1,0,'C');
  ...
  $pdf->Cell(40,5,(substr($expedicion,0,21)),1,1,'L');
  ...
  foreach ($datosAcompanantes as $acompanante) {
    ...
    if(!isset($acompanante['pais'])){
      ...
      $pdf->Cell(30,5,($hotel->getLandGUest($acompanante['pais'])),1,0,'C');
    }
  ...
  $pdf->Cell(20,6,substr(($hotel->getCityExp($datosHuesped[0]['ciudad'])),0,13),1,0,'L');
  ...
  $pdf->Cell(30,6,$hotel->motivoViaje($datosReserva['motivo_viaje']),1,0,'L');
  $pdf->Cell(20,6,'Procedencia',1,0,'L');
  $pdf->Cell(30,6,substr(($hotel->getCityExp($datosReserva['origen_reserva'])),0,20),1,0,'L');
  $pdf->Cell(20,6,'Destino',1,0,'l');
  $pdf->Cell(30,6,substr(($hotel->getCityExp($datosReserva['destino_reserva'])),0,20),1,0,'L');
  ...
  $pdf->Cell(10,6,$datosReserva['num_habitacion'],1,0,'C');
  ...
  $pdf->Cell(50,6,$hotel->formaPago($datosReserva['forma_pago']),1,0,'L');
  ...
  $pdf->Cell(30,6,number_format($datosReserva['valor_diario'],2),1,0,'C');
  $pdf->Cell(20,6,'LLEGADA',1,0,'L');
  $pdf->Cell(30,6,$datosReserva['fecha_llegada'],1,0,'C');
  $pdf->Cell(20,6,'SALIDA',1,0,'L');
  $pdf->Cell(30,6,$datosReserva['fecha_salida'],1,0,'C');
  $pdf->Cell(20,6,('Adultos / Niños'),1,0,'L');
  $pdf->Cell(20,6,$datosReserva['can_hombres']+$datosReserva['can_mujeres'].' / '.$datosReserva['can_ninos'],1,1,'C');
  $pdf->SetFont('Arial','',5);
  $pdf->MultiCell(190,3,('
