<?php 
  ...
  // $pdf->Ln(1);
  // $pdf->SetFont('Arial','B',10);
  $pdf->Cell(195,5,'CARGOS ANULADOS DEL DIA ',0,1,'C');
  // $pdf->Ln(1);
  ...
  $pdf->Cell(50,5,'Motivo Anulacion',0,0,'C');
  $pdf->Cell(10,5,'Hora',0,1,'C');
  $pdf->SetFont('Arial','',9);
  $cargos = $hotel->getCargosAnuladosdelDiaporcajero(FECHA_PMS,$usuario,1,1); 
  ...
  $pdf->Cell(60,5,'Total Cargos Anulados Cajero ',0,0,'L');
