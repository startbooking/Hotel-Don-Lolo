...
// $pdf->ln(2);
$pdf->SetFont('Arial', 'B', 8);
$pdf->Cell(25, 4, (strtoupper(substr($datosReserva['orden_reserva'], 0, 18))), 0, 1, 'L');
$pdf->SetFont('Arial', '', 8);
...
$pdf->Cell(38, 4, $datosReserva['can_hombres'] + $datosReserva['can_mujeres'].'/'.$datosReserva['can_ninos'], 1, 0, 'C');
$pdf->Cell(38, 4, $datosReserva['num_habitacion'], 1, 0, 'C');
$pdf->Cell(38, 4, number_format($datosReserva['valor_diario'], 2), 1, 0, 'C');
$pdf->Cell(38, 4, date('H:m:s'), 1, 0, 'C');

$pdf->Cell(38, 4, str_pad($datosReserva['num_registro'], 4, '0', STR_PAD_LEFT), 1, 1, 'C');
...
$pdf->Cell(47, 4, $datosReserva['fecha_salida'], 1, 0, 'C');
