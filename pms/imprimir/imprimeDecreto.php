...
$pdf->Cell(60, 5, '', 0, 0, 'C');
$pdf->MultiCell(130, 8, ('Solicitud de exención de IVA a Turistas Extranjeros o
...
$pdf->setXY(10, 230);
$pdf->SetFont('Arial', '', 8);
$pdf->MultiCell(60, 5, ('Certifico que valide la información aquí suscrita / I certifico that I validate the information I have subscribed to here.'), 0, 'C');
$pdf->setXY(70, 230);
$pdf->MultiCell(70, 5, ('Certifico que entiendo, acepto y cumplo con los requisitos contenidos en el decreto 297 de 2016 / I certify that I understand, accept and comply with the requirements contained in Decree 297 of 2016. '), 0, 'C');
$pdf->setXY(140, 230);
$pdf->MultiCell(60, 5, ('Certifico que valide el proceso interno establecido por HOTEL DON LOLO LTDA / I certify that it validates the internal process established by HOTEL DON LOLO LTDA.'), 0, 'C');
