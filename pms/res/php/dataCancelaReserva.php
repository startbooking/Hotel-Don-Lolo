    ...
    <div class="panel-body" style="padding:5px">
      <div class="row-fluid place_order">
        <div class="form-group">
          ...
          <div class="col-sm-3">
            <input type="date" class="form-control" name="llegadaUpd" id="llegadaUpd"  value="<?php echo $reserva[0]['fecha_llegada']; ?>" min='<?php
          ...
          <div class="col-sm-1"  style="padding:0 5px">
            <input type="number" class="form-control" name="nochesUpd" id="nochesUpd"  value='<?php echo $reserva[0]['dias_reservados']; ?>' min='1' onchange="sumarDias()" onblur="sumarDias()">
          </div>
          <label for="salida" class="col-sm-2 control-label">Salida</label>
          <div class="col-sm-3">
            <input type="date" onfocus="sumarDias()" onblur="restaFechas()" class="form-control" name="salidaUpd" id="salidaUpd"  value="<?php echo $reserva[0]['fecha_salida']; ?>">
          </div> 
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-4">
            <select name="tipohabiUpd" id="tipohabiUpd" onblur="seleccionaHabitacionUpd(this.value,'<?php echo $reserva[0]['tipo_habitacion']; ?>','<?php echo $reserva[0]['num_habitacion']; ?>')">
              <?php
