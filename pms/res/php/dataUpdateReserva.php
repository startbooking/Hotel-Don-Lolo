  ...
  <div class="panel panel-success" >
    ...
    <div class="panel-body" style="padding:5px">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-10">
          <textarea style="height: 5em !important;min-height: 5em" name="observaciones" id="observaciones" class="form-control" rows="4" readonly=""><?=$reserva[0]['observaciones']?></textarea>
        </div>
      </div>    
      <div class="form-group">
