        ...
        foreach ($huespedes as $huesped) { ?>
	          <tr style='font-size:12px'>
	            ...
	            <td style="padding: 3px 5px;" align="center">
	            	<button onclick="seleccionaHuespedReserva(<?php echo $huesped['id_huesped']; ?>)" type="button" class="btn btn-info btn-xs"><i class="fa fa-check-square-o" aria-hidden="true"></i>
	            	</button>
	            </td>
	          </tr>
	          <?php
