...
foreach ($codigosCiiu as $codigoCiiu) { ?>
                <option value="<?php echo $codigoCiiu['id_ciiu']; ?>"
                  <?php
...
?>
      ...
      <div class="form-group">                  
        ...
        <div class="col-sm-4">
          <input type="text" class="form-control" name="celular" id="celular" value="<?php echo $empresa[0]['celular']; ?>">
        </div>
      </div>
      <div class="form-group">
...
foreach ($tipoAdquiere as $tipoAdqui) { ?>
            ...
            <?php
if ($empresa[0]['tipoAdquiriente'] == $tipoAdqui['id']) {?>
                selected
              <?php
}
    ?>
...
foreach ($tipoRespo as $tipoRes) { ?>
              ...
              <?php
    if ($empresa[0]['tipoResponsabilidad'] == $tipoRes['id']) {?>
                  selected
                <?php
    }
    ?>                                      
