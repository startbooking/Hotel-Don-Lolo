...
<?php 
  require '../../../res/php/app_topHotel.php';  
	...
	if($nuevoPax==1){
		$regis = $hotel->insertaNuevoHuesped($identificaAdiAco, $tipodoc, strtoupper($apellido1), strtoupper($apellido2), strtoupper($nombre1), strtoupper($nombre2), $sexOption, strtoupper($direccion), $telefono, $celular, strtolower($correo), $fechanace, $paices, $ciudadHueAco, $paisExp, $ciudadExpAco, $usuario, $usuario_id, $tipoAdquiriente, $tipoResponsabilidad, $responsabilidadTribu, $empresaAdi, $profesion, $edad);
