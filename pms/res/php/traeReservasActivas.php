              ...
              <div style="display: flex;">
                <?php 
                  ...
                  if(!empty($reserva['observaciones_cancela'])){ ?>
                    <span class="fa-stack fa-xs" title="Observaciones a Cancelacion de la Reserva" style="margin-left:0px;cursor:pointer;" onclick="verObservaciones('<?=$reserva['num_reserva']?>','2')">
