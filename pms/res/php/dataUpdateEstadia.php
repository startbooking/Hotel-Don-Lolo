  ...
  <div class="panel-body" style="padding:5px">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-1" style="padding:0 5px">
        <input type="number" class="form-control" name="noches" id="noches" required="" value='<?= $reserva['dias_reservados'] ?>' min='<?= $dias ?>' onchange="sumarDias()" onblur="sumarDias()">
      </div>
      <label for="salida" class="col-sm-1 control-label">Salida</label>
      <div class="col-sm-3">
        <input type="date" onblur="restaFechas()" class="form-control" name="salida" id="salida" required="" value="<?= $reserva['fecha_salida'] ?>" min="<?= $fecha ?>">
      </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-2">
        <input class="form-control padInput" type="text" name="placavehiculo" id="placavehiculo" value="<?= $reserva['placaVehiculo'] ?>">
      </div>
      <label for="archivo" class="col-sm-1 control-label">Equipaje</label>
      <div class="col-sm-3">
        <input class="form-control padInput" type="text" name="equipaje" id="equipaje" value="<?= $reserva['equipaje'] ?>" disabled>
      </div>
        ...
        <select name="transporte" id="transporte" required disabled>
          ...
          foreach ($motivos as $motivo) { ?>
            <option value="<?php echo $motivo['id_grupo']; ?>"
              <?php
              if ($reserva['tipoTransporte'] == $motivo['id_grupo']) { ?>
              selected
              <?php
              }
    ...
    <div class="form-group">
      ...
      <div class="col-sm-4">
        <input type="text" class="form-control" name="createdusr" id="createdusr" value="<?= $reserva['reservaCreada'] ?>" readonly="">
      </div>
    </div>
  </div>
