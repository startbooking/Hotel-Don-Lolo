      ...
      <section class="content">
        <div class="panel panel-success">
          ...
          <div class="panel-body">
            ...
            <?php 
              $codigos = $hotel->cargosDelDia(FECHA_PMS,'3'); 
                ...
                <div class="table-responsive">
                    ...
                    <tbody>
                      ...
                      foreach ($cargos as $cargo) { ?>
                        <tr style='font-size:12px'>
                          ...
                          <td align="left"><?php 
                            if($cargo['numero_reserva']==0){
                              echo '';
                            }else{                          
                              echo $cargo['numero_reserva']; 
                            }
                          ?></td>
                        </tr>
                        <?php 
                  ...
                  <div class="form-horizontal" style="margin: -20px 0 20px 0;padding:15px;background-color:#dff0d8;border-radius: 3px;">
                    <div class="form-group">
                      <label for="total" class="col-sm-7 control-label">Total Pagos Recibidos</label>
                      <div class="col-sm-2">
                        <input type="text" style="text-align: right;" class="form-control" id="total" placeholder="" value="<?php echo number_format($pagos,2)?>" readonly>
                      </div>
                    </div>
                  </div>
                </div>
