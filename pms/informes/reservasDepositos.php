...
<html>
  <head>
	<title><?= TITLE_PMS ?> | Reservas Esperadas </title>
  ...
  <body class="skin-yellow sidebar-mini">
      ...
      <section class="content">
        <div class="panel panel-success">
          <div class="panel-heading"> 
            <div class="row">
              <div class="col-lg-9">
                ...
                <h3 class="w3ls_head tituloPagina"><i style="color:black;font-size:36px;" class="fa fa-industry"></i> Informe Depositos a Reservas</h3>
              </div>
            </div>
          </div>
          <div class="panel-body">
            ...
            <?php 
              include '../imprimir/imprimeReservasDepositos.php';
            ?>              
          </div>
        </div>
      </section>
    ...
    <script>
      usu = $('#user').val();
      $('#verInforme').attr('data','../imprimir/informes/Informes_reservas_'+usu+'.pdf')
    </script>
