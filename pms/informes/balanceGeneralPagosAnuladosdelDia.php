...
<html>
  <head>
	<title><?= TITLE_PMS ?> | Pagos Anulados del Dia Hotel</title>
          ...
          <div class="panel-heading"> 
            <div class="row">
              <div class="col-lg-9">
                ...
                <h3 class="w3ls_head tituloPagina"><i style="color:black;font-size:36px;" class="fa fa-industry"></i> Pagos Anulados del Dia Por Cajero</h3>
              </div>
          ...
          <div class="panel-body">
            ...
            <?php 
              ...
              foreach ($usuarios as $usuario) { ?>
                ...
                $cargos = $hotel->getCargosAnuladosdelDiaporcajero(FECHA_PMS,$user,3,0); 
                $monto  = 0 ;
                $impto  = 0 ;
                $total  = 0 ;
                $regis  = count($cargos);
                if($regis==0){ ?>
                  <div class="row">
                    <h4 align="center" class="bg-red" style="padding:10px;font-size:30px;width: 60%">Sin Pagos Anulados en el Dia por el Usuario</h4>
                  </div> 
                  <?php 
                }else{
                  ?>
                      ...
                      <tbody>
                        ...
                        foreach ($cargos as $cargo) { ?>
                          <tr style='font-size:12px'>
                            ...
                            <td align="left"><?php echo $cargo['motivo_anulacion']; ?></td>
                          </tr>
                          <?php 
                        }
                        ?>
