                ...
                <div class="form-horizontal">
                  <div class="form-group">
                    ...
                    <div class="col-md-4">
                      ...
                      <a type="bottom" class="btn btn-success pull-right" onclick="buscaFacturasExporta()"
                        href="#">
        ...
        <div class="panel panel-success">
          ...
          <form id="formCierreDiario" class="form-horizontal" method="POST" enctype="multipart/form-data">
            <div class="panel-body">
                ...
                <div class="form-horizontal">
                  <div class="form-group">
                    ...
                    <div class="col-md-4">
                      ...
                      <a type="bottom" class="btn btn-success pull-right" onclick="buscaNotasCreditoExporta()"
                        href="#">
                        <i class="fa fa-search" aria-hidden="true"></i> Buscar
                      </a>
                    </div>   
              ...
              <div class="row">
                <div class="alert alert-danger apaga mensajeNC"><h2 style="text-align:center;">Sin Notas Credito para este dia</h2></div>  
