            ...
            <div class="panel-heading"> 
              <div class="row"> 
                <div class="col-lg-9 col-sm-9">
                  ...
                  <h3 class="w3ls_head tituloPagina"><i style="color:black;font-size:36px;" class="fa fa-industry"></i> Informe Propinas</h3>
                </div>
                <div class="col-lg-3 col-sm-3 derecha">
                  <button class="btn btn-success" type="buttom" onclick='propinasPorFecha()'><i class="fa fa-print" aria-hidden="true"></i> Imprimir</button>
