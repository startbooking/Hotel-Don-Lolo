            ...
            <div class="panel-heading">
              <div class="row">
                <div class="col-lg-9">
                  ...
                  <input type="hidden" name="ubicacion" id="ubicacion" value="balanceCajeros">
                  <h3 class="w3ls_head tituloPagina"> <i class="fa fa-money icon" style="font-size:36px;color:black" ></i> Reprocesar Balance Diario de Cajero</h3>
                </div>
              </div>
            </div>
            <div class="datos_ajax_delete"></div>
            <form id="formCargarHabitaciones" class="form-horizontal" action="javascript:crearMovimientoCajero()" method="POST" enctype="multipart/form-data">
