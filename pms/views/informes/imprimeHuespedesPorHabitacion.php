<?php 
  ...
  if($regis==0){
    ...
    foreach ($reservas as $reserva) {
      ...
      $pdf->Cell(70,5,substr(utf8_decode($reserva['apellido1'].' '.$reserva['apellido2'].' '.$reserva['nombre1'].' '.$reserva['nombre2']),0,34),0,0,'L');
  ...
  $file = 'views/informes/imprimir/Informes_reservas.pdf';
  $pdf->Output($file);
?>
