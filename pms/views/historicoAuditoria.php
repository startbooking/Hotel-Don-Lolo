<?php 
  $ayer  = strtotime ( '-1 day' , strtotime ( FECHA_PMS ) ) ;
              ...
              <div class="panel-body">
                <div class="row_fluid">
                  <div class="col-md-6 form-group">
                    <label for="direccion" class="col-sm-4 control-label">Fecha Auditoria </label>
                    <div class="form-group has-success has-feedback col-sm-8" >
                      <div class="input-group" style="padding-left:15px;">
                        <input type="date" class="form-control" id="buscarFecha" name="buscarFecha" aria-describedby="inputGroupSuccess4Status" value="<?=$ayer?>" max="<?=$ayer?>">
                ...
                <div class="row_fluid" style="margin-top: 50px">
