                        ...
                        <ul class="nav navbar-nav" style="margin :0">
                          <li classgetSalidasRealizadas="dropdown dropdownMenu pull-right">
                            ...
                            <ul class="dropdown-menu submenu" style="float:left;margin-left:none;">
                              <li>
                                <a data-toggle="modal" href="#myModalAnularSalida" data-id="<?php echo $reserva['num_reserva'] ?>" data-tipohab="<?php echo descripcionTipoHabitacion($reserva['tipo_habitacion']) ?>" data-nrohab="<?php echo $reserva['num_habitacion'] ?>" data-nombre="<?php echo $reserva['nombre_completo'] ?>" data-impto="<?php echo $reserva['causar_impuesto'] ?>" data-llegada="<?php echo $reserva['fecha_llegada'] ?>" data-salida="<?php echo $reserva['fecha_salida'] ?>" data-noches="<?php echo $reserva['dias_reservados'] ?>" data-hombres="<?php echo $reserva['can_hombres'] ?>" data-mujeres="<?php echo $reserva['can_mujeres'] ?>" data-ninos="<?php echo $reserva['can_ninos'] ?>" data-tarifa="<?php echo $hotel->getNombreTarifa($reserva['tarifa']) ?>" data-valor="<?php echo $reserva['valor_reserva'] ?>" data-observaciones="<?php echo $reserva['observaciones'] ?>">
                                  <i class="fa fa-sign-in" aria-hidden="true"></i> Reactivar Estadia</a>
                              </li>
                              <li>
                                <a data-toggle="modal" data-id="<?php echo $reserva['num_reserva'] ?>" data-apellido1="<?php echo $reserva['apellido1'] ?>" data-apellido2="<?php echo $reserva['apellido2'] ?>" data-nombre1="<?php echo $reserva['nombre1'] ?>" data-nombre2="<?php echo $reserva['nombre2'] ?>" onclick="imprimirRegistro(<?= $reserva['num_reserva'] ?>,<?= $reserva['causar_impuesto'] ?>)">
