            ...
            <div class="panel-heading">
              <div class="row">
                <div class="col-lg-9">
                  ...
                  <h3 class="w3ls_head tituloPagina"> <i class="fa fa-money icon" style="font-size:36px;color:black" ></i> Reprocesar Balance Diario - Acumulado</h3>
                </div>
              </div>
            </div>
            <div class="datos_ajax_delete"></div>
            <form id="formCargarHabitaciones" class="form-horizontal" action="javascript:crearMovimientoDiarioAcumulado()" method="POST" enctype="multipart/form-data">
