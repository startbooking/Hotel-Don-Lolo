...
<div class="content-wrapper" id="recaudosCartera">
  <section class="content" style="position: relative;">
    <div class="col-lg-10 col-xs-12 base" style="position: absolute;top: 10%;left: 0;right:0;bottom:0;margin:auto;">
      <form id="guardarBaseCaja" class="form-horizontal" action="javascript:guardaCartera()">
        ...
        <div class="panel panel-success">
          ...
          <div class="panel-body">
            ...
            <div class="form-group ph-15" name="traeFacturas" id="traeFacturas" style="max-height: 220px;overflow: auto;">
              <table name="datosClienteCartera" id="dataClientes" class="table table-responsive mb-10">
                <thead>
            ...
            <div class="form-group">
              ...
              <div class="col-lg-4 col-md-4">
                <input type="number" class="form-control tr" id="totalpago" name="totalpago" min="0" required readonly value="0">
              </div>
            </div>
          </div>
          <div class="panel-footer">
            <div class="container-fluid tc">
              <div class="btn-group" style="text-align:center;">
                <a href="recaudosCartera" type="button" class="btn btn-warning"><i class="fa fa-reply"></i> Regresar</a>
