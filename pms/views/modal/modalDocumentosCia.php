<div class="modal fade bs-example-modal-lg" id="myModalDocumentosCia" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog modal-md" role="document">
    <div class="modal-content">
      <div class="modal-header">  
        ...
        <h4 class="modal-title" id="myModalLabel"> <i class="fa fa-user-plus"></i> Documentos Compañia</h4>
        <input type="hidden" name="txtIdCiaDoc" id="txtIdCiaDoc">

        <div class="container-fluid" ></div>
        <div class="modal-body" id="muestraImagenesCia" style="height: 350px;overflow: auto;">
        </div>
        <div class="modal-footer">
          <div class="btn-group">
            ...
            <a
              data-toggle="modal" 
              data-target="#myModalSubirDocumentoCia" 
...
<div class="modal fade" id="myModalSubirDocumentoCia" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog modal-md" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <input type="hidden" name="txtIdCiaUpl" id="txtIdCiaUpl"> 
      </div>

      <form method="POST" name="uploadFiles" id="uploadFiles" style='padding:0' enctype="multipart/form-data" action='javascript:subirArchivosCia()'>
...
<div class="modal fade bs-example-modal-lg" id="myModalMuestraDocumentoCia" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog modal-md" role="document">
    <div class="modal-content">
      <div class="modal-header">  
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true" class='glyphicon glyphicon-off' style="color:#530505"></span>
