...
<div class="modal fade" id="myModalAdicionaGrupo" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div id="dataRegisterRoom" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        <form class="form-horizontal" id="formGrupo" action="javascript:guardaGrupo()" method="POST">
          <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span class="glyphicon glyphicon-off"></span>
            </button>
            <h3 class="modal-title" id="exampleModalLabel"> <i class="fa-solid fa-users-between-lines"></i> Nuevo Grupo</h3>
          </div>
          <div class="modal-body" id="modalGrupos">
            <div id="mensaje apaga"></div>
            <div class="form-group">
              ...
              <div class="col-sm-6" >
                <select name="empresaGrupo" id="empresaGrupo" required="">
            ...
            <div class="form-group">
              <label for="nombreGrupo" class="col-sm-2 control-label">Nombre del Grupo</label>
              <div class="col-sm-6" style="padding-right: 20px">
                <input type="text" class="form-control" name="nombreGrupo" id="nombreGrupo" required="" value="">
              </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              <label for="tipohabi" class="col-sm-2 control-label">Habitaciones</label>
              <div class="col-sm-4">
                <input type="number" class="form-control" name="cantHabi" id="cantHabi" required="" value='1' min=1>
              </div>
          ...
          <div class="modal-footer">
            ...
            <button class="btn btn-success" style="text-align:right;"><i class="fa fa-save" aria-hidden="true"></i> Guardar</button>
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Adicionar Huesped</h4>
      </div>
      <form id="nuevoHuespedReserva" class="form-horizontal" action="javascript:guardaHuespedReserva()">
        <div class="modal-body" style="font-size:12px;">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-4">
              <input type="text" class="form-control" name="nombre1" id="nombre1" placeholder="1er Nombre" required>
            </div>
