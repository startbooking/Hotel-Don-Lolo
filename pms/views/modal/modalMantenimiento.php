        ...
        <form class="form-horizontal" id="formAdicionaMantenimiento" action="javascript:guardaMantenimiento()" method="POST">
          ...
          <div class="modal-body" id="modalReservasIns">
            <div class="form-group">
              ...
              <div class="col-sm-2" style="padding-right: 5px">
                <input style="padding: 4px;" type="date" class="form-control" name="desdeFechaAdi" id="desdeFechaAdi" required="" value="<?= FECHA_PMS ?>">
              </div>
              <label for="hastaFechaAdi" class="col-sm-2 control-label">Hasta Fecha</label>
              <div class="col-sm-2" style="padding-right: 5px">
                <input style="padding: 4px;" type="date" class="form-control" name="hastaFechaAdi" id="hastaFechaAdi" required="" value="<?= $manana ?>">
              </div>
            </div>
            <div class="apaga" id="divReserva">
              <div class="table-responsive">
                <div class="alert alert-warning" style="text-align:center;margin:0px;">
                  <h4 style="margin:0px;">Asigne Primero Nueva Habitacion a las Reservas </h4>
                </div>
