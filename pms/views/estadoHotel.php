      ...
      <div class="panel panel-success">
        ...
        <div class="panel-body">
          <div class="container-fluid">
            <h4 class="alert alert-success tituloEstado">Estado Habitaciones</h4>
            ...
            <div class="container-fluid ocupacion">
              <div class="row form-group">
                ...
                <div class="col-sm-2" style="padding:5px">
                  <input type="text" class="form-control" name="habiDisp" id="habiDispt" readonly="" value="<?= $paxs[0]['habi'] ?>">
                </div>
                <label for="nit" class="col-sm-2 control-label">% Ocupacion</label>
                <div class="col-sm-2" style="padding:5px">
                  <input type="text" class="form-control" name="porceOcu" id="porceOcu" readonly="" value="<?= round(($paxs[0]['habi'] / $habdisp) * 100,2) ?>">
                </div>
              </div>
              <div class="row form-group">
