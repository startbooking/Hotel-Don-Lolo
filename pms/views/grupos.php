            ...
            <tbody>
              ...
              foreach ($grupos as $grupo) { ?>
                <tr style='font-size:12px'>
                  ...
                  <td><?=$grupo['totalHuespedes']?></td>
                  <td><?=$grupo['totalHabitaciones']?></td>
                  <td><?=$grupo['cuentaMaestra']?></td>
                  <td><?=$grupo['idTarifa']?></td>
                  <td><?=estadoReserva($grupo['estado'])?></td>
                  <td>
                    <nav class="navbar navbar-default" style="margin-bottom: 0px;min-height:0px;">
                      <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1" style="padding:1px">
                        <ul class="nav navbar-nav">
                          <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false" style="padding: 3px 1px;">Ficha Grupo<span class="caret"></span></a>
