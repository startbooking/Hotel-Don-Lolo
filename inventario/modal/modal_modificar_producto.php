<form id="actualidarDatosProducto" class="form-horizontal">
      ...
      <div class="modal-body">
        ...
        <div class="form-group">
          ...
          <div class="col-lg-2 col-md-2">
            <input type="text" class="form-control" id="codigo" name="codigo" required maxlength="6" readonly>
          </div>
        ...
        <div class="form-group">
          ...
          <div class="col-lg-4 col-md-4">
            <select name="grupo_inven" id="grupo_inven" required>
              <?php 
              $sql_fam = "SELECT * FROM grupos_inve ORDER BY des_grup" ;
              $res_fam = mysqli_query($conn,$sql_fam);
              while($row_fam=mysqli_fetch_assoc($res_fam)){
                ?>
                <option value="<?=$row_fam['cod_grup']?>"><?=$row_fam['des_grup']?></option>
        ...
        <div class="form-group" id="subgrupo">
          ...
          <div class="col-lg-4 col-md-4">
            <select name="subgrupo_inven" id="subgrupo_inven" requierd>
              <?php 
              $sql_sub = "SELECT * FROM subgrupos_inve ORDER BY des_subg" ;
              $res_sub = mysqli_query($conn,$sql_sub);
              while($row_sub=mysqli_fetch_assoc($res_sub)){
                ?>
                <option value="<?=$row_sub['cod_subg']?>"><?=$row_sub['des_subg']?></option>
        ...
        <div class="form-group">
          ...
          <div class="col-lg-4 col-md-4">
            <input type="text" class="form-control" id="costo" name="costo" min='0'> 
          </div>
          <label for="promedio" class="control-label col-lg-2  col-md-2">Precio Promedio</label>
          <div class="col-lg-4 col-md-4">
            <input type="text" class="form-control" id="promedio" name="promedio" min='0'> 
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-lg-2 col-md-2">
            <input type="number" class="form-control" id="equivale" name="equivale" min='0' > 
          </div>
