          ...
          <section class="content-header">
            <div class="box-tools pull-right" align="fixed">
              <ul class="pagination pagination-sm inline">
                <li><a href="#"><img src="../../img/cero/addi.png" width="40px">  Adicionar Receta</a></li>
                <li><a href="../index.php" ><img src="../../img/cero/home.png" width="40px">  Retornar</a></li>
              </ul>
            </div>
            <h1>
            <small>Datos</small>
              <p>Catalogo de Recetas</p>
            </h1>
          </section>
	      <section class="content">
	        <div class="box-header">    
  		      <iframe alignt="center" width="100%" height="420" frameborder="0" src="../code/sele_rece.php" >
  		 	  </iframe>
		    </div>
	      </section>
  	    </div>
