<?php 
  ...
  include_once('../../Conn/valida_ingreso.php');
	...
	if($_GET['o'] == 'add') { 
		// add order
	 	echo "<div class='div-request hide'>add</div>";
        ...
        <section class="content" style='margin-left:30px'>
					<div class="panel panel-default">
						<div class="panel-heading">
							...
							<?php if($_GET['o'] == 'add') { ?>
					  		<i class="glyphicon glyphicon-plus-sign"></i>	Agregar Entrada
							<?php } else if($_GET['o'] == 'manord') { ?>
								<i class="glyphicon glyphicon-edit"></i> Listado de Movimientos de Entradas
							<?php } else if($_GET['o'] == 'editOrd') { ?>
								<i class="glyphicon glyphicon-edit"></i> Editar Entrada
							<?php } ?>
						...
						<div class="panel-body">
							...
							// /else manage order
					  		...
					  		<form class="form-horizontal" method="POST" action="php_action/editOrder.php" id="editOrderForm">
					  			...
					  			$sql= "SELECT m.numero, m.fecha_movimiento, m.requisicion, m.estado, m.usuario, p.empresa, t.descripcion, b.nom_alma, SUM(valor_total) as valor FROM movimientos_inventario AS m, proveedores as p, tipo_movimiento_inv t, bodegas b where m.id_proveedor = p.id_prov and m.tipo_movi = t.codigo and m.bodega = b.cod_alma and m.tipo= 1 GROUP BY m.numero order by m.numero";

					  			// $sql = "SELECT orders.order_id, orders.order_date, orders.client_name, orders.client_contact, orders.sub_total, orders.vat, orders.total_amount, orders.discount, orders.grand_total, orders.paid, orders.due, orders.payment_type, orders.payment_status FROM orders WHERE orders.order_id = {$orderId}";
