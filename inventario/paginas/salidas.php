...
<html>
  ...
  <body class="skin-yellow sidebar-mini" onload='pone_almacen_movimientos();pone_almacen();pone_tipo_movimiento();pone_proveedor();pone_producto();pone_impuesto();pone_unidad()'>
    <?php 
    ...
    <div class="content-wrapper"> 
      <section class="content" style='margin-left:30px'>
        <?php 
          include_once("../modal/modal_salida_movimientos.php");
          include_once("../modal/modal_anula_movimientos.php");
          include_once("../modal/modal_movimientos.php");  
        ?>
        <div class="row">
          <h4 align="center">Salidas de Inventarios</h4>
          <div class="row-fluid">
            <div class="mov_entradas"></div>
            <div id="loader"></div>
