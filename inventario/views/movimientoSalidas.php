    ...
    <form id="salidaMovimientos" class="form-horizontal" style="padding :0">
      <div class="panel panel-success">
        <div class="panel-heading">
          ...
          <h3 class="w3ls_head tituloPagina"><i style="color:black;font-size:36px;" class="fa fa-calendar"></i> Nueva Salida de Inventarios </h3>
        </div>
            ...
            <div class='col-md-6'>
              ...
              <div class='row-fluid'>
                ...
                <div class='btn-group pull-right' style="margin-top:8px">
                  <button class='btn btn-primary' type='button' onclick='agregaListaSalida();' id='btn-add-article' disabled><i class='fa fa-download'></i> Agregar</button>
          ...
          <div class="row">
            ...
            <div class="col-lg-6">
              <div class='btn-group pull-right'>
                <button class='btn btn-warning btn-md' type='button' onclick='cancelaEntrada(2);' id='btn-cancela'><i class='fa fa-times'></i> Cancelar Salida</button>
                <button class='btn btn-primary btn-md' type='button' onclick='procesaEntrada(2);' id='btn-procesa' disabled><i class='fa fa-external-link'></i> Procesar Salida</button>
              </div>
            </div>
          </div>
        </div>
