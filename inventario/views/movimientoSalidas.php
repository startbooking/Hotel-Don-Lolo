          ...
          <div class="row">
            ...
            <div class="col-lg-6">
              <div class='btn-group pull-right'>
                <button class='btn btn-warning btn-md' type='button' onclick='cancelaSalida();' id='btn-cancela'><i class='fa fa-times'></i> Cancelar Salida</button>
                <button class='btn btn-primary btn-md' type='button' onclick='procesaSalida(2);' id='btn-procesa' disabled><i class='fa fa-external-link'></i> Procesar Salida</button>
              </div>
            </div>
          </div>       
        </div>
