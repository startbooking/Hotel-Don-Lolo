          ...
          <div class="panel-heading"> 
            <div class="container-fluid" style="padding:0">
              <div class="col-lg-3" style="padding:0">
                ...
                <h3 class="w3ls_head tituloPagina"><i style="color:black;font-size:36px;" class="fa fa-cubes"></i> Ingreso Conteos </h3>
              </div>
            </div>
            ...
            <div class="row-fluid">              
              <div class="col-lg-6">                 
                <div class="form-horizontal">
                  <label class="col-lg-4 col-md-4 col-sm-4 control-label">Bodega de Conteo</label>
                  <div class="col-lg-8 col-md-8 col-sm-8">                  
                    <select class="form-control" name="bodega" id="bodega" onblur='conteoInventario(this.value)'>
