<?php 
  ...
  $pdf->Cell(195,7,'TRASLADO DE INVENTARIO',0,1,'C');
  $pdf->Ln(1);
  $pdf->Cell(30,6,'TRASLADO NRO ',0,0,'L');
  ...
  $pdf->SetFont('Arial','',10);
  $pdf->Cell(60,6,$inven->getBuscaMovimiento($movSal),0,1,'L');
  $pdf->SetFont('Arial','B',10);
  $pdf->Ln(1);
  ...
  $pdf->Cell(95,5,'',0,0,'L');
  $pdf->SetFont('Arial','B',10);
  $pdf->Cell(55,6,'VALOR TOTAL SALIDA ',1,0,'R');
  ...
  $pdf->Cell(30,6,'BODEGA',0,0,'l');
  $pdf->SetFont('Arial','',10);
  $pdf->Cell(60,6,$inven->buscaAlmacen($destino),0,0,'L');
  $pdf->SetFont('Arial','B',10);
  $pdf->Cell(40,6,'TIPO MOVIMIENTO',0,0,'l');
  $pdf->SetFont('Arial','',10);
  $pdf->Cell(60,6,$inven->getBuscaMovimiento($movEnt),0,1,'L');
