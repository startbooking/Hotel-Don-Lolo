...
$movimientos = $inven->getMovimientos(4, $numero, $almacen);
...
$pdf->SetFont('Arial', '', 10);
$pdf->Cell(60, 6, $inven->getBuscaMovimiento($tipomov), 0, 1, 'L');
$pdf->SetFont('Arial', 'B', 10);
$pdf->Ln(1);
...
foreach ($movimientos as $movimiento) {
  ...
  $pdf->Cell(50, 6, substr(($movimiento['nombre_producto']), 0, 25), 1, 0, 'L');
  ...
  if ($movimiento['impuesto'] == null) {
    $pdf->Cell(25, 6, number_format(0, 2), 1, 0, 'R');
  } else {
...
$file = '../../imprimir/Ajuste_' . $numero . '.pdf';
