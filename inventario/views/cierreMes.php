          ...
          <div class="form -group">
            <div class="form-group">
              <label style="margin-top:8px" for="fechaAuditoria" class="control-label"> 
                <h3 id="fechaAuditoria" style="font-weight: 700;margin-top: 0;font-size:20px;color:brown;text-align: center"> Periodo a Cerrar <small class="badge btn btn-success" style="font-size:18px"> <?=str_pad($periodo,2,'0',STR_PAD_LEFT) ?>  </small> 
               <?=nombreMes($periodo)?> </h3>
              </label>
            </div>
          </div>                                
