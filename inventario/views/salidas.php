      ...
      <div class="panel-heading">
        <div class="row">
          ...
          <div class="col-lg-6 col-xs-12" align="right">
            ...
            <button class="btn btn-info" onclick="exportarJSONaExcel(<?php echo htmlspecialchars(json_encode($salidas)); ?>, 'tablaSalidas')"><i class="glyphicon glyphicon-th" aria-hidden="true"></i> Exportar Movimientos</button>
          </div>
        </div>
      </div>
